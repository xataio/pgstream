...
func NewTimestampTransformer(generatorType transformers.GeneratorType, params transformers.Parameters) (*TimestampTransformer, error) {
...
func (t *TimestampTransformer) Transform(value any) (any, error) {
