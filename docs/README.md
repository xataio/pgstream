...
| PGSTREAM_POSTGRES_SNAPSHOT_STORE_REPEATABLE | False                  | No       | Allow to repeat snapshots requests that have been already completed succesfully. By default snapshots that have been completed won't be repeated.                                                                                                                                                            |
