...
| PGSTREAM_POSTGRES_SNAPSHOT_EXCLUDE_ROLES             | False            | No       | When using `pg_dump`/`pg_restore` to snapshot schema for Postgres targets, option to disable snapshotting roles.
