...
| PGSTREAM_POSTGRES_INITIAL_SNAPSHOT_STORE_URL        | ""                     | No       | Postgres URL for the database where the snapshot requests and their status will be tracked. A table `snapshot_requests` will be created under a `pgstream` schema.                                                                                                                                           |
| PGSTREAM_POSTGRES_INITIAL_SNAPSHOT_STORE_REPEATABLE | False                  | No       | Allow to repeat snapshots requests that have been already completed succesfully. By default snapshots that have been completed won't be repeated.                                                                                                                                                            |
