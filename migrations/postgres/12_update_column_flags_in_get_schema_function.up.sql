-- Update pgstream.get_schema function to add a column identity flag and a
-- generated kind flag in order to capture the kind of generated column. Can't
-- change the type of the existing generated flag to avoid breaking changes.
