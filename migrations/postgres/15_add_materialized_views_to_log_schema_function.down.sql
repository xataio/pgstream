-- Restore the previous version of the log_schema function without materialized
-- view handling and previous version of the drop event trigger
DROP EVENT TRIGGER IF EXISTS pgstream_log_schema_drop;
