-- Revert to the previous version where CREATE TRIGGER events are silently
-- skipped due to a NULL schema_name from pg_event_trigger_ddl_commands()
...
DROP FUNCTION IF EXISTS pgstream.get_trigger_schema(oid);
