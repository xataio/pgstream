-- Update function to emit DDL changes as logical messages for stateless schema
-- tracking using pgstream.table_ids mapping to populate pgstream_id for tables.
